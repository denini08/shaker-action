...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec('sh', ['-c', 'chmod', '+x', './gradlew']);
            ...
            yield exec.exec('sh', ['echo', adbRunTestsComand, '>>', 'tests.sh']);
            yield exec.exec('sh', ['chmod +x', 'exec.sh', 'tests.sh']);
            console.log("!!! RUNNING SHAKER by js");
            yield exec.exec('sh', ['python3', 'exec.py', '3', 'name']);
